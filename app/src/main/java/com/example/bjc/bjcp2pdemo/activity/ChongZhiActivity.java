...
import com.example.bjc.bjcp2pdemo.util.pay.PayKeys;
import com.example.bjc.bjcp2pdemo.util.pay.PayResult;
import com.example.bjc.bjcp2pdemo.util.pay.SignUtils;
...
//设置button的可点击性
    ...
    @OnClick({R.id.ib_back, R.id.chongzhi_btn})
